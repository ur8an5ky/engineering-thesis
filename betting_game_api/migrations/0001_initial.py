    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_match', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='betting_game_api.footballmatches')),
            ],
        ),
        migrations.AddField(
            model_name='footballmatches',
            name='id_hosts',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hosted_matches', to='betting_game_api.footballteams'),
        ),
        migrations.AddField(
            model_name='footballmatches',
            name='id_visitors',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='visited_matches', to='betting_game_api.footballteams'),
        ),
    ]
